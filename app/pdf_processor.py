...
class PDFProcessor:
    ...
    def extract_text_by_page(self, pdf_source: Union[str, Path, BinaryIO, bytes]) -> List[str]:
        """
    ...
    def extract_sections(self, pdf_source: Union[str, Path, BinaryIO, bytes]) -> List[Section]:
        """
            ...
            for page_num in range(len(doc)):
                ...
                for block in blocks:
                    ...
                    for line in block["lines"]:
                        ...
                        if is_header and len(text.strip()) > 2 and len(text.strip()) < 100:
    ...
    def extract_tables(self, pdf_source: Union[str, Path, BinaryIO, bytes]) -> List[TableData]:
        """
    ...
    def _open_document(self, pdf_source: Union[str, Path, BinaryIO, bytes]) -> fitz.Document:
        """
