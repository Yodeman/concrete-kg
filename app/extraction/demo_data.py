...
def get_demo_extraction_result() -> ExtractionResult:
    ...
    portland_cement = MaterialComposition(
        ...
        components=[
            ChemicalComponent(
                ...
                percentage=65.0, role="binder", category="oxide"
            ),
            ChemicalComponent(
                name="Silicon Dioxide", formula="SiO2", 
                percentage=22.0, role="binder", category="oxide"
            ),
            ChemicalComponent(
                name="Aluminum Oxide", formula="Al2O3", 
                percentage=5.5, role="modifier", category="oxide"
            ),
            ChemicalComponent(
                name="Iron Oxide", formula="Fe2O3", 
                percentage=3.5, role="flux", category="oxide"
            ),
            ChemicalComponent(
                name="Magnesium Oxide", formula="MgO", 
                percentage=2.0, role="minor", category="oxide"
            ),
            ChemicalComponent(
                name="Sulfur Trioxide", formula="SO3", 
                percentage=2.0, role="setting_regulator", category="oxide"
            ),
        ],
        properties={
    ...
    fly_ash = MaterialComposition(
        ...
        components=[
            ChemicalComponent(
                name="Silicon Dioxide", formula="SiO2", 
                percentage=55.0, role="pozzolanic", category="oxide"
            ),
            ChemicalComponent(
                name="Aluminum Oxide", formula="Al2O3", 
                percentage=25.0, role="pozzolanic", category="oxide"
            ),
            ChemicalComponent(
                name="Iron Oxide", formula="Fe2O3", 
                percentage=10.0, role="inert", category="oxide"
            ),
            ChemicalComponent(
                name="Calcium Oxide", formula="CaO", 
                percentage=5.0, role="reactive", category="oxide"
            ),
        ],
        properties={
    ...
    silica_fume = MaterialComposition(
        ...
        components=[
            ChemicalComponent(
                name="Silicon Dioxide", formula="SiO2", 
                percentage=92.0, role="pozzolanic", category="oxide"
            ),
            ChemicalComponent(
                name="Carbon", formula="C", 
                percentage=3.0, role="impurity", category="inorganic"
            ),
            ChemicalComponent(
                name="Iron Oxide", formula="Fe2O3", 
                percentage=1.5, role="minor", category="oxide"
            ),
        ],
        properties={
    ...
    substitutions = [
        SubstitutionRelationship(
            ...
            property_changes={"strength_7d": -15, "durability": 20, "heat_of_hydration": -25}
        ),
        SubstitutionRelationship(
            original="Portland Cement",
            ...
            property_changes={"strength_28d": 18, "permeability": -40, "workability": -30}
        ),
        SubstitutionRelationship(
            original="Portland Cement",
            ...
            property_changes={"strength_7d": -25, "durability": 35, "co2_reduction": 40}
        ),
        SubstitutionRelationship(
