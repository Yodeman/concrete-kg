...
class ChemicalComponent(LLMExportableModel):
    ...
    category: Optional[str] = Field(
        default=None,
        description="Category: 'oxide', 'mineral', 'organic', 'inorganic'"
    )
...
class MaterialComposition(LLMExportableModel):
    ...
    components: List[ChemicalComponent] = Field(
        ...
        description="List of chemical components in this material"
    )
    ...
    source: Optional[str] = Field(
        default=None,
        description="Source document or standard (e.g., 'ASTM C150')"
    )
